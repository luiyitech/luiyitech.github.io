...
const personas = [
    ...
    { nombre: "Wetsch Brenda Gianella", provincia: "Entre Ríos" },
    { nombre: "Machado Andrés, Ernesto Ricardo", provincia: "Entre Ríos" },
    { nombre: "Marelli Lucia", provincia: "Santa Fe" },
    { nombre: "Rau Cynthia Gabriela", provincia: "Entre Ríos" },
    { nombre: "Claudel Soraya Castelli", provincia: "Entre Ríos" },
    { nombre: "Correa Ariadna Micaela", provincia: "Entre Ríos" },
    { nombre: "Villanueva María del Rosario", provincia: "Entre Ríos" },
    { nombre: "Bernard Sol", provincia: "Santa Fe" },
    { nombre: "Rodriguez Nicolás", provincia: "Santa Fe" },
    { nombre: "Diaz Denise", provincia: "Entre Ríos" },
    { nombre: "Minaudori Brenda Cruz", provincia: "Entre Ríos" },
    { nombre: "THEFS SERGIO JOSE", provincia: "Río Negro" },
    { nombre: "Fanega Carla Daniela", provincia: "Santa Fe" },
    { nombre: "Forzatti Grinovet Christian Exequiel", provincia: "Entre Ríos" },
    { nombre: "Russi Osvaldo Victor", provincia: "Entre Ríos" },
    { nombre: "Gómez Ríos Victor", provincia: "Entre Ríos" },
    { nombre: "Weigandt. Barbara Agustina", provincia: "Entre Ríos" },
    { nombre: "Barboza María Martina", provincia: "Entre Ríos" },
    { nombre: "Musso Giannina", provincia: "Entre Ríos" },
    { nombre: "Martinez Flavio Emmanuel", provincia: "Entre Ríos" },
    { nombre: "Jofre Yamila", provincia: "Entre Ríos" },
    { nombre: "Aranguiz Rodriguez Yolanda", provincia: "Bs As" },
    { nombre: "Nani Constanza", provincia: "San Luis" },
    { nombre: "Darin Mariana Muñoz", provincia: "San Luis" },
    { nombre: "Bendz Martina", provincia: "Entre Ríos" },
    { nombre: "Leguizamón Ana Paula", provincia: "Entre Ríos" },
    { nombre: "Castaldo Florencia", provincia: "Entre Ríos" },
    { nombre: "Machado Melina Abril", provincia: "Entre Ríos" },
    { nombre: "Aguimar María Lorena", provincia: "Buenos Aires" },
    { nombre: "Alcántara Luisina", provincia: "Buenos Aires" },
    { nombre: "Martínez Ariadna", provincia: "Entre Ríos" },
    { nombre: "Krohling Alén", provincia: "Entre Ríos" },
    { nombre: "Saffore Quacciuccone Agostina", provincia: "Santa Fe" },
    { nombre: "Aguirre Florencia", provincia: "Santa Fe" },
    { nombre: "Rojas Ascaino Natalia Belén", provincia: "Entre Ríos" },
    { nombre: "Jannone Carla Gian", provincia: "Santa Fe" },
    { nombre: "Raim Rocio Daiana", provincia: "Entre Ríos" },
    { nombre: "Galli Iara", provincia: "Entre Ríos" },
    { nombre: "Páez Camila", provincia: "Entre Ríos" },
    { nombre: "Masetto Valentina", provincia: "Entre Ríos" },
    { nombre: "Solis Carmela", provincia: "Entre Ríos" },
    { nombre: "Samaruga Mline Naiara", provincia: "Entre Ríos" },
    { nombre: "Frías Juan Pablo nicolás", provincia: "Entre Ríos" },
    { nombre: "Basaldua Oriana", provincia: "Entre Ríos" },
    { nombre: "González Melina", provincia: "Buenos Aires" },
    { nombre: "Yamila Tomaschini", provincia: "Buenos Aires" },
    { nombre: "Sánchez Agostina Noemi", provincia: "San Luis" },
    { nombre: "Alicia Isabel Copes", provincia: "Córdoba" },
    { nombre: "Pereyra Daniela Katherine", provincia: "Santa Fe" },
    { nombre: "Arruco Cotes", provincia: "Córdoba" },
    { nombre: "Elgart Joaquín Francisco", provincia: "Entre Ríos" },
    { nombre: "Ingeme Charles Carlos Eduardo", provincia: "CABA" },
    { nombre: "Gomez Mariel Ailen", provincia: "Buenos Aires" },
    { nombre: "García Candela", provincia: "Santa Fe" },
    { nombre: "Valenzuela Anabella", provincia: "Entre Rios" },
    { nombre: "Milagros", provincia: "Entre Ríos" },
    { nombre: "Assi Camila", provincia: "Entre Ríos" },
    ...
    { nombre: "Raguileo Romina", provincia: "Córdoba" },
    { nombre: "Foglino Marco Gonzalo", provincia: "Córdoba" },
    { nombre: "Foglino Sandro Fabian", provincia: "Santa Fe" },
    { nombre: "Hernández Thompson Manuela", provincia: "Santa Fe" },
    { nombre: "Andrey Silvina Strcen Schelske", provincia: "Misiones" }
];
